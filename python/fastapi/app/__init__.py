...
"""
 Python FastAPI App
 -
 This is a backend API app based on FastAPI in Python, and a sample app to implement data of Administrative units in Vietnam.

 References
 -
 Project: **Administrative units in Vietnam**
 "
